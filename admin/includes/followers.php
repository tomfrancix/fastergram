<div class="container-fluid">
    <div class="row" style="margin-top:-10px;">
        <label class="form-control" style="color:white;background-color:transparent;border:none;border-bottom:1px solid rgba(100,100,100,0.5);">People who follow you</label>
<?php
        followuser();
        unfollowuser();
if(isset($_GET['followers'])) { }
//    $the_user_id = $_GET['followers'];

if(isset($_SESSION['id'])) {
    $sessionid = $_SESSION['id'];
}
$query = "SELECT * FROM following WHERE follow_to_user_id = {$sessionid} ORDER BY follow_id DESC ";
...
if($ufollow_to_user_id == $user_id) {    $following = true;  ?>
                    ...
                    <a href="index.php?source=followers&unfollowuser=<?php echo $ufollow_id; ?>" type="submit" name="unfollowuser"  style="text-align:center;width:100%;" class="btn btn-default dark">Unfollow</a>
...
<script> document.getElementById('navbar-header').innerHTML = "Followers";</script>